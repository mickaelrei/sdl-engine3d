...
void Engine3D::setup()
{
    ...
    // Seconds arm
    Mesh secondArm = Mesh::Cylinder(secondArmRadius, secondArmLength, resolution);
    ...
    // Minutes arm
    Mesh minuteArm = Mesh::Cylinder(minuteArmRadius, minuteArmLength, resolution);
    // Position based on angle
    ...
    // Hours arm
    Mesh hourArm = Mesh::Cylinder(hourArmRadius, hourArmLength, resolution);
    ...
    sceneMeshes.push_back(secondArm);
    sceneMeshes.push_back(minuteArm);
    sceneMeshes.push_back(hourArm);
    sceneMeshes.push_back(clockFloor);
